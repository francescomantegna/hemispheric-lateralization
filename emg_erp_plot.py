...
times = np.arange(0,1.001,0.002)
n_times = len(times)

# load elecromyography data
...
[ax.plot(times,data_covert.mean(0)[ii]*1e6, 'k', lw=0.5) for ii in range(2)]
ax.set_ylim([-3, 3])
ax.set_xlim([0, 1])
ax.set_yticks([-3,-1.5, 0, 1.5, 3])
ax.tick_params(labelsize=14)
ax.set_ylabel(r'$\mu$V', fontsize=14)
...
fig, ax = plt.subplots(1,1,figsize=(8,6))
[ax.plot(times,data_viewing.mean(0)[ii]*1e6, 'k', lw=0.5) for ii in range(2)]
ax.set_ylim([-3, 3])
ax.set_xlim([0, 1])
ax.set_yticks([-3,-1.5, 0, 1.5, 3])
ax.tick_params(labelsize=14)
